...
parcelHelpers.export(exports, "expenseCategories", ()=>expenseCategories);
var _view = require("./view");
var _chartView = require("./chart.view");
class Expense {
...
function updateCategoryOptions() {
    ...
    const categories = selectedType === "Entrata" ? incomeCategories : expenseCategories;
...
document.getElementById("income-form").addEventListener("submit", (event)=>{
    ...
    const newIncome = new Expense(amount, category, date, description, type, newIncomeId);
    operations.expenseList.push(newIncome);
    (0, _view.addToTable)(date, description, category, amount, newIncomeId, type, onDeleteCallback);
    (0, _chartView.updateChart)(category, amount, type);
    (0, _chartView.updateColumnChart)(category, amount, type);
    (0, _view.addToTotal)(type, amount);
    console.log(newIncome);
    console.log(operations.expenseList);
});

},{"./view":"ai2uB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./chart.view":"ikS1Q"}],"ai2uB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addToTable", ()=>addToTable);
parcelHelpers.export(exports, "addToTotal", ()=>addToTotal);
const addToTable = function(date, description, category, amount, id, type, onDeleteCallback) {
    ...
    const displayAmount = type === "Entrata" ? `${amount}\u{20AC}` : `-${amount}\u{20AC}`;
    row.innerHTML = `
...
const addToTotal = function(type, amount) {
    ...
    if (type === "Entrata") {
        ...
        totalIncome.textContent = `${incomeValue}\u{20AC}`;
    } else {
        expenseValue += amountValue;
        totalExpense.textContent = `${expenseValue}\u{20AC}`;
    }
    const totalValue = incomeValue - expenseValue;
    total.textContent = `${totalValue}\u{20AC}`;
};
...
},{}],"ikS1Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateChart", ()=>updateChart);
parcelHelpers.export(exports, "updateColumnChart", ()=>updateColumnChart);
...
const pieChart = new (0, _auto.Chart)(canvas, {
    type: "pie",
    data: budgetData
});
const updateChart = function(category, amount, type) {
    if (type !== "Entrata") {
        // Considera solo le spese
        const index = pieChart.data.labels.indexOf(category);
        if (index !== -1) pieChart.data.datasets[0].data[index] += parseFloat(amount);
        else {
...
const columnChart = new (0, _auto.Chart)(columnCanvas, {
    data: {
        datasets: [
            {
                type: "bar",
...
const updateColumnChart = function(category, amount, type) {
    if (type !== "Entrata") {
        // Considera solo le spese
        const index = columnChart.data.labels.indexOf(category);
        if (index !== -1) columnChart.data.datasets[0].data[index] += parseFloat(amount);
        else {
...
let lineChart = new (0, _auto.Chart)(ctx, {
    type: "line",
    data: {
        labels: labels,
        datasets: [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aJPIF","8ZNvh"], "8ZNvh", "parcelRequire30ab")

//# sourceMappingURL=budget.f5c48570.js.map
